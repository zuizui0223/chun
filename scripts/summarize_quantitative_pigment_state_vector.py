...
def main():
    ...
    systems=[
      ...
      {'independence_cluster':'OIL_CAMELLIA_MULTI','quantitative_layer':'reported_metabolites_colour_material','contrast':'anthocyanin_minus_flavonol','direction':sign(oil['anthocyanin_minus_flavonol_R_W']),'within_system_evidence':'red material R vs white material W','effect_value':oil['anthocyanin_minus_flavonol_R_W'],'effect_unit':'difference of class log2 fold changes','heterogeneity_note':'source taxon-name mapping conflicts; only W/P/CP/R material labels are admitted'},
      {'independence_cluster':'CSIN_WHITE_PINK','quantitative_layer':'reported_expression','contrast':'anthocyanin_minus_proanthocyanidin','direction':'mixed','within_system_evidence':cs['S6_anthocyanin_minus_PA_positive_stages'],'effect_value':'','effect_unit':'stage-direction consistency','heterogeneity_note':'only 3/5 stages positive and stage-average relative contrast is approximately zero/slightly negative; PA cannot be merged with FLS'},
