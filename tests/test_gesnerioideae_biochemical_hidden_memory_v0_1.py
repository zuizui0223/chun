...
SCRIPT=ROOT/"scripts"/"analyze_gesnerioideae_biochemical_hidden_memory_v0_1.py"
spec=importlib.util.spec_from_file_location("ghm",SCRIPT)
...
def test_within_coarse_permutation_preserves_counts():
