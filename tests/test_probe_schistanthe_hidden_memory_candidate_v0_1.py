...
def test_candidate_file_names_are_fixed():
    assert mod.COLOR_FILE=="Vireya_RADsamples_tiplabels_ingroup_color_clade.csv"
    assert mod.TREE_FILE=="VireyaRADd10m5c91R1_0717_Rdref_min4_raxml_treePLCIs.mean.newick.named"
