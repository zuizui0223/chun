...
- system-level permutation P = **0.031096890310968902**;
...
The corrected hosted recheck **passed** in run `33045356947`. The authoritative promotion candidate therefore uses the frozen-code values in this document. Candidate-free measurements, yellow-development results and macroevolutionary results were unchanged by the recheck.
