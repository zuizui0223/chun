...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="paper1_v08_docx_") as td:
        base_summary = Path(td) / "docx_v07_summary.json"
        subprocess.run(
            [
                sys.executable,
                "scripts/build_paper1_ajb_docx_v0_7.py",
                "--source", str(a.source),
                "--out", str(a.out),
    ...
    summary = {
        **inherited,
        ...
        "status": "AJB v0.8 DOCX built and structurally audited",
    }
